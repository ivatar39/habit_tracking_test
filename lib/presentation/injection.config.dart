...
import '../application/habits/habit_form/habit_form_bloc.dart' as _i8;
import '../application/habits/habit_watcher/habit_watcher_bloc.dart' as _i9;
import '../application/main/main_bloc.dart' as _i7;
import '../domain/habits/i_habit_repository.dart' as _i5;
import '../infrastructure/core/api_injectable_module.dart' as _i10;
...
_i1.GetIt $initGetIt(_i1.GetIt get,
  ...
  gh.factory<_i8.HabitFormBloc>(
      () => _i8.HabitFormBloc(get<_i5.IHabitRepository>()));
  gh.factory<_i9.HabitWatcherBloc>(
      () => _i9.HabitWatcherBloc(get<_i5.IHabitRepository>()));
  return get;
}

class _$ApiInjectableModule extends _i10.ApiInjectableModule {}
